...
import logo from "../assets/Bantul-logo.png";
				...
				<div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2 sm:p-4">
					<a
						...
						<div className="flex flex-col min-w-0 flex-1">
							<span
								className={`text-xs sm:text-sm md:text-lg font-medium truncate sm:whitespace-nowrap transition-colors duration-300 ${
							...
							<span
								className={`transition-all duration-300 ${
									isScrolled
										...
										: "text-sm sm:text-base md:text-xl font-semibold text-gray-800"
								}`}>
					...
					<div
						...
						id="navbar-solid-bg">
						<ul
							className={`flex flex-col font-medium mt-4 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent transition-colors duration-300 ${
								isScrolled
